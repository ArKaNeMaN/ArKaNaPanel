...
function clickServerEdit(id){
	...
	');
	$('#serversAdminEditGame').html($('#serversAdminAddGame').html());
	$('#serversAdminEditGame :selected').attr('selected', null);
	$('#serversAdminEditGame [value="'+editInfo.game+'"]').attr('selected', '');
